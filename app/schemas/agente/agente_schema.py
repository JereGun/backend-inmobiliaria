...
class AgenteBase(BaseModel):
    ...
    fecha_nacimiento: Optional[str] = Field(..., title="Fecha de nacimiento", description="Fecha de nacimiento del agente")
...
class AgenteOut(AgenteBase):
    ...
    fecha_alta: str = Field(..., title="Fecha de alta", description="Fecha de alta del agente")
